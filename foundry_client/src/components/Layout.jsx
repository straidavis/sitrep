...
const Layout = ({ children }) => {
    ...
    // Legacy server check removed - assuming online or handling offline gracefully via FoundryService errors
    useEffect(() => {
        // No-op or replace with Foundry connectivity check if desired
    }, []);
    ...
    if (roles && roles.includes('App.Admin')) {
