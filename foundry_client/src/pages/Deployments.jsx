...
const Deployments = () => {
    ...
    const { refreshDeployments } = useDeployment();
    ...
    const handleSaveDeployment = async (deploymentData) => {
        try {
            ...
            setShowModal(false);
            setEditingDeployment(null);
            await loadDeployments(); // Local Refresh
            await refreshDeployments(); // Global Context Refresh
        } catch (error) {
                        ...
                        <tbody>
                            {filteredDeployments.length === 0 ? (
                                ...
                                filteredDeployments.map((deployment, idx) => {
                                    ...
                                    return (
                                        <tr key={deployment.id || `idx-${idx}`} style={rowStyle}>
